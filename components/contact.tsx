  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (serviceId && templateId && publicKey) {
        ...
        setSubmitStatus('error');
        console.error('EmailJS env is missing: set NEXT_PUBLIC_EMAILJS_* variables');
      }
    } catch (error) {
      setSubmitStatus('error');
    } finally {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            I welcome the opportunity to discuss projects, explore collaborations, or connect professionally. I am always open to new challenges and opportunities.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              <div>
                ...
                I am seeking new opportunities as a Full Stack Developer.
                If you have a project to discuss, collaboration in mind, or would like to connect professionally, I would be glad to hear from you.
                </p>
              </div>
